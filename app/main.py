...
from app.routers import auth_router, users_router, watchlist_router, favorites_router, tmdb_router, reviews_router, follows_router, user_stats_router, lists_router, activity_router, notifications_router, ai_router, payments_router, trakt_router, discover_router, watched_router
